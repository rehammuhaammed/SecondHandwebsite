      ...
      if (carId) {
        try {
          ...
          if (user) {
           ...
           this.showMsg('Congratulations! You have successfully purchased this car.', 'success');
...
msgType: 'success' | 'error' = 'success';
    ...
    if (this.car) {
      ...
      if (carId) {
        try {
          ...
          if (!feedback) {
              this.showMsg('Please enter feedback!', 'error');
              return;
            }

             // Notify user about successful feedback submission
            this.showMsg('Feedback sent successfully!', 'success');
  ...
  showMsg(message: string, type: 'success' | 'error' = 'success') {
  this.msg = message;
  this.msgType = type;
